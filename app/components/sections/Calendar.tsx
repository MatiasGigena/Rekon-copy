    ...
    >
        ...
        {width && width < 1024 &&
          <>
            ...
            <Image className="absolute scale-[0.65] top-20 right-[263px] md:scale-100 ift:right-[300px] md:top-24 md:left-10" src="/Navigation.png" alt="RekonMedia Logo" height={20} width={173} quality={100} />
            <Image className="absolute scale-[0.65] top-[18rem] left-[190px] ift:left-[220px] md:scale-100 -rotate-6 md:top-[23rem] md:left-[29rem] z-30  " src="/Mensaje.png" alt="RekonMedia Logo" height={20} width={280} quality={100} />
