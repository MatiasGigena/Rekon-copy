  ...
  return (
    ...
    >
      <div className="absolute top-96" id="aboutUs" data-listen-section></div>
        <div className="linear linearB gap-3 md:gap-5 p-4 md:p-6 lg:p-8 xl:p-12 rounded-[16px] backdrop-blur-sm flex flex-col lg:gap-10 relative">
          <h2 className={
        ...
        {width && width >= 1024 &&
          <>
            <Image className="absolute lg:top-[16rem] lg:left-[0rem] xl:top-[25rem] xl:left-10 1/2xl:left-32 2xl:top-[18.5rem] 2xl:left-44 3xl:top-[18rem] 3xl:left-[22rem]" src="/3D Shape.png" alt="RekonMedia Logo" height={20} width={200} quality={100} />
            <Image className="absolute lg:top-[36rem] lg:right-[0rem] xl:top-[49rem] xl:right-10 1/2xl:right-32  z-[-30] 2xl:top-[42rem] 2xl:right-40 3xl:top-[42rem] 3xl:right-[22rem] " src="/3D Torus.png" alt="RekonMedia Logo" height={20} width={200} quality={100} />
        ...
        {width && width < 1024 && width > 640 &&
          <>
            <Image className="absolute sm:left-[-1rem] sm:top-[12.5rem] md:left-[-1rem] md:top-[16.3rem]" src="/3D Shape.png" alt="RekonMedia Logo" height={20} width={100} quality={100} />
            <Image className="absolute  sm:right-[-1rem] sm:top-[25rem] md:right-[-1rem] md:top-[31rem]  z-[-30] " src="/3D Torus.png" alt="RekonMedia Logo" height={20} width={100} quality={100} />
