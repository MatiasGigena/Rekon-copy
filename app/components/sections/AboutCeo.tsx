...
const AboutCEO = () => {
  ...
  <Avatar className="w-[50%] z-20 h-[150px] xs:w-[25%] xs:h-[140px] 
    sm:w-[25%] sm:h-[150px]
    md:w-[30%] md:h-[200px] 
    lg:w-[18%]  lg:h-[316px]
    xl:w-[18%]  xl:h-[316px]
  ...
  <div className="flex flex-col z-20 backdrop-blur-3xl colorbout2 rounded-tl-[9px] rounded-tr-[23px] rounded-br-[23px] rounded-bl-[26px] justify-center 
  h-[100px]
  xs:w-[80%] xs:h-[140px]
  sm:h-[150px] sm:w-[80%]  
  md:h-[200px] md:w-[80%]
  ...
  ">
    <div className=" py-10 flex h-full justify-between mt-10 items-center w-full flex-col gap-1 xs:gap-3 xl:gap-10 relative">
      <p className={`${montserrat.className} font-semibold text-[10px]  text-[#FAFAFA]  lg:mb-7 xl:mb-0     xxs:text-[10px] sm:text-base  lg:text-[23px] lg:leading-[30px]  lg:w-[419px]`}>
      ...
      <div
        className="flex flex-row gap-2 sm:gap-4 lg:gap-6 px-10 w-full justify-between  items-center"
      >
        <i className={`${inter.className} text-[7px] leading-[8.5px]  text-[#FAFAFA]   xxs:text-[7px] sm:text-sm xl:text-base xl:leading-6 font-normal md:text-sm left-0 relative top-1/2 -translate-y-1/2`}>
        Matias Del Curto - <strong>Founder & CEO</strong>
      </i>
        <div
          className='flex flex-row gap-2 sm:gap-3 lg:gap-8 flex-wrap  '
        >
